        ...
        'product_category' => [
            ...
            'translation' => [
                'description' => [
                    ...
                    'placeholder' => 'توضیحات دسته‌بندی محصولات',
                ],
                'meta_title' => [
                    'label' => 'عنوان متا',
                    'info' => 'عنوان متا دسته‌بندی محصولات',
                    'placeholder' => 'عنوان متا دسته‌بندی محصولات',
                ],
                'meta_description' => [
                    'label' => 'توضیحات متا',
                    'info' => 'توضیحات متا دسته‌بندی محصولات',
                    'placeholder' => 'توضیحات متا دسته‌بندی محصولات',
                ],
                'meta_keywords' => [
                    'label' => 'کلمات کلیدی متا',
                    'info' => 'کلمات کلیدی متا دسته‌بندی محصولات',
                    'placeholder' => 'کلمات کلیدی متا دسته‌بندی محصولات',
                ],
            ],
            'metadata' => [
                'column_number' => [
